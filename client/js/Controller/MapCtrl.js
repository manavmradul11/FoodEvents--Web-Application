...
app.controller("MapCtrl", function ($rootScope, $scope, MyService, $element, $compile, $http, LoginService) {
    ...
    function setMarker(map, position, title, content) {
        ...
        var markerOptions = {
            ...
            title: title,
            icon: '/Project/client/img/red-dot.png'
        };

        if (title == 'You are here') {
            markerOptions.icon = '/Project/client/img/blue_dot.png';
    ...
    function getApiUrl() {
        var url = "https://api.eventful.com/json/events/search?app_key=k6C5qrCrdBgZMSkw";
